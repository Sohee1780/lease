...
function rightBtn(){
    indexBanner += 1;
        ...
        document.getElementById('banner').style.backgroundImage=`url(images/${pics[indexBanner]})`;
}
...
window.addEventListener('load', function(){
        ...
        document.getElementById('banner').style.backgroundImage='url(images/'+pics[0]+')';
